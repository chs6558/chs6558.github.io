...
module.exports = function (_ref, pluginOptions) {
  ...
  var generateImagesAndUpdateNode = function generateImagesAndUpdateNode(node, resolve, inLink, overWrites) {
    ...
    return _regenerator["default"].async(function generateImagesAndUpdateNode$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            _context.next = 12;
            return _regenerator["default"].awrap(fluid({
              file: imageNode,
              args: options,
              reporter: reporter,
              cache: cache
          ...
          case 36:
            ...
            _context.next = 44;
            return _regenerator["default"].awrap(traceSVG({
              file: imageNode,
              args: args,
              fileArgs: args,
              cache: cache,
          ...
          case 46:
            ...
            _context.next = 53;
            return _regenerator["default"].awrap(stats({
              file: imageNode,
              reporter: reporter
            }));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              _context2.next = 11;
              return _regenerator["default"].awrap(generateImagesAndUpdateNode(node, resolve, inLink, overWrites));
    ...
    return (// HTML image node stuff
      ...
      rawHtmlNodes.map(function (_ref5) {
        ...
        return new Promise(function _callee2(resolve, reject) {
          var $, imageRefs, _i2, _imageRefs, thisImg, formattedImgTag, _fileType, _rawHTML2;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 16:
                  ...
                  if (!(isRelativeUrl(formattedImgTag.url) && _fileType !== "gif" && _fileType !== "svg")) {
                    _context3.next = 26;
                    break;
                  }

                  _context3.next = 20;
                  return _regenerator["default"].awrap(generateImagesAndUpdateNode(formattedImgTag, resolve, inLink));
